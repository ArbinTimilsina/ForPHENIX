...
void plotJet()
{
    ...
    species->AddText("p+Au @ 200 GeV, anti-kt, R = 0.3 jet");
    ...
    species->Draw("SAME");
    cCf->Update();
    cCf->SaveAs("/gpfs/mnt/gpfs02/phenix/spin/spin1/phnxsp01/arbint/pAuJet/plots/Cf.png");
    ...
    cJets->SaveAs("/gpfs/mnt/gpfs02/phenix/spin/spin1/phnxsp01/arbint/pAuJet/plots/Jets.png");
}
