...
my $evntdir = "/direct/phenix+hhj/arbint/JetSimulation/JetConstituentPerformance/particle";
...
#Create pythia.cfg
    ...
    system("cd $evntdir/$dir; echo \'#!/bin/csh\' >> JetConstituentPerformance.cmd");
    system("cd $evntdir/$dir; echo \'source /opt/phenix/bin/odbcini_setup.csh\' >> JetConstituentPerformance.cmd");
    system("cd $evntdir/$dir; echo \'cd $evntdir/$dir\' >> JetConstituentPerformance.cmd");
...
#Set the code
    ...
    system("cd $evntdir/$dir; echo \'root -l -q -b \"runJetConstituentPerformance.C($R, $minPt, $ncPythia, $minCfPythia, $maxCfPythia, 0.09, 0.04, $nevents, false, true)\"\' >> JetConstituentPerformance.cmd");
