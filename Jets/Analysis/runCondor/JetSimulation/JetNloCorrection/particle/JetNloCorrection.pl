...
my $evntdir = "/direct/phenix+scratch/arbint/JetNloCorrection/particle";
...
#Set PYTHIA
    ...
    system("cd $evntdir/$dir; ln -sf /direct/phenix+u/arbint/Jets/Analysis/runCondor/JetSimulation/JetNloCorrection/particle/pythia.cfg");
