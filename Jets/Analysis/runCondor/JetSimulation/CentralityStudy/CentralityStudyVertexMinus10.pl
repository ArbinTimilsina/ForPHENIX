...
my $mainDir = "/phenix/hhj/arbint/JetSimulation/CentralityStudy/VertexMinus10";
...
#Set PISA
    ...
    print CENTRALITYSTUDY_CMD "ln -sf /direct/phenix+u/arbint/Jets/Analysis/code/JetSimulation/centMacros/event.par_vertexMinus10 event.par\n";
