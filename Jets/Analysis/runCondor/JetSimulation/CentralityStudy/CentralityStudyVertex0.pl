...
my $mainDir = "/phenix/hhj/arbint/JetSimulation/CentralityStudy/Vertex0";
...
#Set PISA
    ...
    print CENTRALITYSTUDY_CMD "ln -sf /direct/phenix+u/arbint/Jets/Analysis/code/JetSimulation/centMacros/event.par_vertex0 event.par\n";
