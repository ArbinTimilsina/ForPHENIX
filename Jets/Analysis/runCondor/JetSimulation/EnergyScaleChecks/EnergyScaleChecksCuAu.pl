...
#Set PYTHIA
    ...
    print ENERGYSCALECHECKS_CMD "ln -sf /direct/phenix+u/arbint/Jets/Analysis/runCondor/JetSimulation/EnergyScaleChecks/phhijing.cfg .\n";
    print ENERGYSCALECHECKS_CMD "ln -sf /direct/phenix+u/arbint/Jets/Analysis/code/JetSimulation/simMacros/generateHijing.C .\n";
    print ENERGYSCALECHECKS_CMD "root -l -q -b \"generateHijing.C($nevents)\"\n";
