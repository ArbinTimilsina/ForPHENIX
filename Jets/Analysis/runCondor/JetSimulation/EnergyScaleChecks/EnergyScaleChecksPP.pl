...
my $runDir = "/direct/phenix+hhj/arbint/JetSimulation/EnergyScaleChecks/PP";
print "Writing out events to dir: $runDir\n\n";
sleep(5);

my $ii = 0;
for($ii=50000;$ii<$segments;$ii++) {
...
#Set PISA
    ...
    print ENERGYSCALECHECKS_CMD "ln -sf /direct/phenix+u/arbint/Jets/Analysis/code/JetSimulation/simMacros/pcDeadArea/pad_deadroc_360934.dat pad_deadroc.dat\n";
    print ENERGYSCALECHECKS_CMD "ln -sf /direct/phenix+u/arbint/Jets/Analysis/code/JetSimulation/simMacros/pcDeadArea/pad_deadch_360934.dat pad_deadch.dat\n";
    print ENERGYSCALECHECKS_CMD "pisa < pisa.input\n";

#Set PISA to DST
    print "Setting PISA to DST\n\n";
    print ENERGYSCALECHECKS_CMD "root -l -q -b \"pisaToDST.C($nevents, 360934)\" \n";
...
#Set the code
    ...
    print ENERGYSCALECHECKS_CMD "root -l -q -b \"runEnergyScaleChecks.C($nevents, false)\"\n";
