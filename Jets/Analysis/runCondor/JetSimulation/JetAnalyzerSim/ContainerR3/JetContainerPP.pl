...
my $runDir = "/phenix/hhj/arbint/JetSimulation/JetAnalyzerSim/ContainerR3/PP";
...
#    print "Setting PYTHIA\n\n";
    print JETCONTAINERANALYZER_CMD "ln -sf /direct/phenix+u/arbint/Jets/Analysis/runCondor/JetSimulation/JetAnalyzerSim/ContainerR3/pythia.cfg .\n";
    ...
    print JETCONTAINERANALYZER_CMD "ln -sf /direct/phenix+u/arbint/Jets/Analysis/runCondor/JetSimulation/JetAnalyzerSim/ContainerR3/generatePythia.C .\n";
...
#Submit the job
    system("cd $runDir/$dir; ln -sf /direct/phenix+u/arbint/Jets/Analysis/runCondor/JetSimulation/JetAnalyzerSim/ContainerR3/JetContainerAnalyzer.job");
