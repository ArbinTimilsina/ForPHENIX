...
my $analyzerDir = "/phenix/hhj/arbint/JetSimulation/JetAnalyzerSim/AnalyzerR3/PP";
my $containerDir = "/phenix/hhj/arbint/JetSimulation/JetAnalyzerSim/ContainerR3/PP";
...
#Create JetAnalyzerSim.cmd script
    ...
    print JETANALYZERSIM_CMD "root -l -q -b \"runJetAnalyzerSim.C($R, $minPt, $nc, $minCf, $maxCf, 0.3)\"\n";
    close(JETANALYZERSIM_CMD);

#Submit the job
    system("cd $analyzerDir/$aDir; ln -sf /direct/phenix+u/arbint/Jets/Analysis/runCondor/JetSimulation/JetAnalyzerSim/AnalyzerR3/JetAnalyzerSim.job");
