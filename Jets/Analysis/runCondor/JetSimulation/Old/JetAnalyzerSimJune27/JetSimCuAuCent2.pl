...
my $mainDir = "/direct/phenix+hhj/arbint/JetSimulation/JetAnalyzerSim/CuAuCent2";
...
#Set Run 12 Cu+Au data
    ...
    print JETANALYZERSIM_CMD "root -l -q -b \"generateData.C($R, $nc, $minPtData, $minCf, $maxCf, $nevents, $skipEvents, 2)\"\n";
