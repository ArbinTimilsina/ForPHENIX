...
my $evntdir = "/direct/phenix+scratch/arbint/JetSimEfficiency/perfectEMCalDCNc8CfNoDR";
...
#Create pythia.cfg
    ...
    system("cd $evntdir/$dir; echo \'root -l -q -b \"generatePythia.C($R, $ncPythia, $minPt, $minCfPythia, $maxCfPythia, $nevents)\"\' >> JetAnalyzerSim.cmd");
...
#Set the code
    ...
    system("cd $evntdir/$dir; echo \'root -l -q -b \"runJetAnalyzerSimPP.C($R, $minPt, $nc, $minCf, $maxCf, $ncPythia, $minCfPythia, $maxCfPythia, 1.0, $nevents, true)\"\' >> JetAnalyzerSim.cmd");
