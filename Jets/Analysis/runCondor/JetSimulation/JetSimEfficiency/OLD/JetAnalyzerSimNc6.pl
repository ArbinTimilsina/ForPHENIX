...
my $evntdir = "/direct/phenix+scratch/arbint/JetSimEfficiency/nc6";
...
#Set the code
    ...
    system("cd $evntdir/$dir; echo \'root -l -q -b \"runJetAnalyzerSimPP.C($R, $minPt, $nc, $minCf, $maxCf, $ncPythia, $minCfPythia, $maxCfPythia, 0.5, $nevents)\"\' >> JetAnalyzerSim.cmd");
