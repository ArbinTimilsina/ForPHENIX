...
my $evntdir = "/direct/phenix+scratch/arbint/JetSimEfficiency/perfectDC_EMCal_Particle_Nc6";
...
#Set the code
    ...
    system("cd $evntdir/$dir; echo \'root -l -q -b \"runJetAnalyzerSimPP.C($R, $minPt, $nc, $minCf, $maxCf, $ncPythia, $minCfPythia, $maxCfPythia, 0.029, $nevents, true, true)\"\' >> JetAnalyzerSim.cmd");
