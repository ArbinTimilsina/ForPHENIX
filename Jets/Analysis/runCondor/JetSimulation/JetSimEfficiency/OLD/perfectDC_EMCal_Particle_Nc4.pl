...
my $evntdir = "/direct/phenix+scratch/arbint/JetSimEfficiency/perfectDC_EMCal_Particle_Nc4";
...
#Set the code
    ...
    system("cd $evntdir/$dir; echo \'root -l -q -b \"runJetAnalyzerSimPP.C($R, $minPt, $nc, $minCf, $maxCf, $ncPythia, $minCfPythia, $maxCfPythia, 0.025, $nevents, true, true)\"\' >> JetAnalyzerSim.cmd");
