...
my $evntdir = "/direct/phenix+scratch/arbint/JetSimEfficiency/perfectEMCalDCNc8Cf";
...
#Set the code
    ...
    system("cd $evntdir/$dir; echo \'root -l -q -b \"runJetAnalyzerSimPP.C($R, $minPt, $nc, $minCf, $maxCf, $ncPythia, $minCfPythia, $maxCfPythia, 0.030, $nevents, true)\"\' >> JetAnalyzerSim.cmd");
