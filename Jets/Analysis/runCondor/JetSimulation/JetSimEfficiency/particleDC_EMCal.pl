...
my $evntdir = "/direct/phenix+scratch/arbint/JetSimEfficiency/particle_DC_EMCal";
...
#Set the code
    ...
    system("cd $evntdir/$dir; echo \'root -l -q -b \"runJetAnalyzerSimPP.C($R, $minPt, $nc, $minCf, $maxCf, $ncPythia, $minCfPythia, $maxCfPythia, 0.2,0.2,0.2, $nevents, true, true)\"\' >> JetAnalyzerSim.cmd");
