...
my $evntdir = "/direct/phenix+scratch/arbint/JetSimEfficiency/particle_DC_EMCal_noDr";
...
#Set the code
    ...
    system("cd $evntdir/$dir; echo \'root -l -q -b \"runJetAnalyzerSimPP.C($R, $minPt, $nc, $minCf, $maxCf, $ncPythia, $minCfPythia, $maxCfPythia, 1.0,1.0,1.0,$nevents, true, true)\"\' >> JetAnalyzerSim.cmd");
