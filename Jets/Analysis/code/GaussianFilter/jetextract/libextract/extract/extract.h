...
private:
	...
	jet::factorized_background_model_t *_background_model_cu_cu_03_perp;
	jet::factorized_background_model_t *_background_model_cu_cu_05_perp;
	jet::general_background_model_t *_background_model_au_au_03_perp;
	jet::factorized_background_model_t *_background_model_03_time;
	jet::factorized_background_model_t *_background_model_03_z;
	jet::factorized_background_model_t *_background_model_05_time;
	jet::factorized_background_model_t *_background_model_05_z;
	jet::reconstruction_filtering_iir_t *_filter_03;
	jet::reconstruction_filtering_iir_t *_filter_05;
	jet::reconstruction_t *_kt_03;
	jet::reconstruction_t *_kt_05;
	jet::reconstruction_t *_antikt_03;
	jet::reconstruction_t *_antikt_05;
	jet::reconstruction_t *_siscone_03;
	jet::reconstruction_t *_siscone_05;
...
public:
	enum {
		SCALEDOWN_NONE = 0,
		SCALEDOWN_FIXED_4,
		JET_RECONSTRUCT_RUN_5_P_P,
		JET_RECONSTRUCT_RUN_5_CU_CU,
		JET_RECONSTRUCT_RUN_7_AU_AU,
		JET_RECONSTRUCT_RUN_8_D_AU,
	};
	event_writer_t(
