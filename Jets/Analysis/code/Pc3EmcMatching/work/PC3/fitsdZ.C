...
void fitsdZ()
{
      ...
      for (int ized = 0; ized < NZED; ized++)
        {
          for (int icent = 0; icent < NCENT; icent++)
            {
              h2F[iarm][ized][icent] = (TH2F*)f->Get(Form("hPc3sdZFinal%d_%d_%d", iarm, ized, icent));
  ...
  //Initialize the sdZ and esdZ also
  float sdZ[NCHARGE][NARM][NZED][NCENT][NPT][nbinx];
  float esdZ[NCHARGE][NARM][NZED][NCENT][NPT][nbinx];

  //In addition, initialize the mean and sigma historams
  TH1F *hMeansdZ[NCHARGE][NARM][NZED][NCENT];
  TH1F *hSigmasdZ[NCHARGE][NARM][NZED][NCENT];
              ...
              for (int icent = 0; icent < NCENT; icent++)
                {
                  ...
                  hMeansdZ[icharge][iarm][ized][icent] = new TH1F(Form("hMeansdZ_%d_%d_%d_%d", icharge, iarm, ized, icent),
								     Form("hMeansdZ_%d_%d_%d_%d", icharge, iarm, ized, icent),
								     NPT, mombins);


                  hMeansdZ[icharge][iarm][ized][icent]->SetTitle(Form("PC3 <sdZ> (final): %s, %s", charge[icharge], centrality[icent]));
                  hMeansdZ[icharge][iarm][ized][icent]->SetTitleSize(0.6);
                  hMeansdZ[icharge][iarm][ized][icent]->SetMarkerStyle(28);
                  hMeansdZ[icharge][iarm][ized][icent]->SetMarkerColor(col);


                  hSigmasdZ[icharge][iarm][ized][icent] = new TH1F(Form("hSigmasdZ_%d_%d_%d_%d", icharge, iarm, ized, icent),
								      Form("hSigmasdZ_%d_%d_%d_%d", icharge, iarm, ized, icent),
								      NPT, mombins);


                  hSigmasdZ[icharge][iarm][ized][icent]->SetTitle(Form("PC3 #sigma_{sdZ} (final): %s, %s", charge[icharge], centrality[icent]));
                  hSigmasdZ[icharge][iarm][ized][icent]->SetTitleSize(0.6);
                  hSigmasdZ[icharge][iarm][ized][icent]->SetMarkerStyle(29);
                  hSigmasdZ[icharge][iarm][ized][icent]->SetMarkerColor(col);

                  for (int ipt = 0; ipt < NPT; ipt++) //pt bin
                    {
                      h1F[icharge][iarm][ized][icent][ipt] = new TH1F(Form("h_PC3sdZ_%d_%d_%d_%d_%d", icharge, iarm, ized, icent, ipt),
								       Form("h_PC3sdZ_%d_%d_%d_%d_%d", icharge, iarm, ized, icent, ipt),
								       nbinx, binmin, binmax);
                      ...
                      h1F[icharge][iarm][ized][icent][ipt]->SetTitle("PC3sdZ");
                      h1F[icharge][iarm][ized][icent][ipt]->GetXaxis()->SetTitle("sdZ");
                      h1F[icharge][iarm][ized][icent][ipt]->GetXaxis()->SetRangeUser(min, max);

                      for (int ix = 0; ix < nbinx; ix++)  // sdZ bin
                        {
                          sdZ[icharge][iarm][ized][icent][ipt][ix] = 0.0;
                          esdZ[icharge][iarm][ized][icent][ipt][ix] = 0.0;
                        }
                    }
                }
            }
              ...
              for (int iy = 1; iy <= h2F[iarm][ized][icent]->GetNbinsY(); iy++)  //pt
                {
                  ...
                  for (int ix = 1; ix <= nbinx; ix++)  //sdZ
                    {
		      sdZ [charge][iarm][ized][icent][kbin][ix-1] += h2F[iarm][ized][icent]->GetBinContent(ix, iy);
                      esdZ[charge][iarm][ized][icent][kbin][ix-1] += pow(h2F[iarm][ized][icent]->GetBinError(ix, iy), 2);
                    }
                }
            }
        }
              ...
              for (int icent = 0; icent < NCENT; icent++)
                {
                  for (int ipt = 0; ipt < NPT; ipt++) //pt
                    {
                      for (int ix = 0; ix < nbinx; ix++)  // sdZ bin (cout some statements here)
                        {
                          h1F[icharge][iarm][ized][icent][ipt]->SetBinContent(ix + 1, sdZ[icharge][iarm][ized][icent][ipt][ix]);
                          h1F[icharge][iarm][ized][icent][ipt]->SetBinError(ix + 1, sqrt(esdZ[icharge][iarm][ized][icent][ipt][ix]));
                        }
                    }
                }
            }
          ...
          for (int ized = 0; ized < NZED; ized++)
			...
			h1F[icharge][iarm][ized][icent][ipt]->Rebin(3);
		      ...
		      fpeak->SetLineWidth(2);
                      ...
                      hMeansdZ[icharge][iarm][ized][icent]->SetBinContent (ipt + 1, fpeak->GetParameter(1));
                      hMeansdZ[icharge][iarm][ized][icent]->SetBinError (ipt + 1, fpeak->GetParError(1));

                      hSigmasdZ[icharge][iarm][ized][icent]->SetBinContent (ipt + 1, fpeak->GetParameter(2));
                      hSigmasdZ[icharge][iarm][ized][icent]->SetBinError (ipt + 1, fpeak->GetParError(2));
      ...
      for (int iarm = 0; iarm < NARM; iarm++)
        {
		  ...
		  if (!(iarm == 0 && ized == 5 && icharge==0 && icent==0)) continue;
                  ...
                  for (int ipt = 0; ipt < NPT; ipt++) //pt
                    {
                      ...
                      if (icharge == 0 && iarm == 0 && ized == 0 && icent == 0 && ipt == 3)
                        {
                          TCanvas *cSinglesdZ = new TCanvas("cSinglesdZ", "Single sdZ", 1000, 700);
			  ...
			  fsg->Draw("same");
                          ...
                          t00->Draw();
                          t1->Draw();
                          cSinglesdZ->SaveAs("/direct/phenix+hhj/arbint/plots/Pc3EmcMatching/dz/ptFit/ptFit_single.png");
                          cSinglesdZ->Close();
                        }
		  ...
		  cfit[icharge][iarm][ized][icent]->SaveAs(Form("/direct/phenix+hhj/arbint/plots/Pc3EmcMatching/dz/ptFit/ptFit_Charge%d_Sect%d_Zed%d_Cent%d.png", icharge, iarm, ized, icent));
  ...
  for (int iarm = 0; iarm < NARM; iarm++)
    {
          ...
          for (int icharge = 0; icharge < NCHARGE; icharge++)
            {
              ...
              for (int ized = 0; ized < NZED; ized++)
                {
                  hMeansdZ[icharge][iarm][ized][icent]->SetStats(0);
                  hMeansdZ[icharge][iarm][ized][icent]->SetMaximum(5.0);
                  hMeansdZ[icharge][iarm][ized][icent]->SetMinimum(-5.0);

                  hMeansdZ[icharge][iarm][ized][icent]->GetYaxis()->SetTitle("<sdZ>");
                  hMeansdZ[icharge][iarm][ized][icent]->GetYaxis()->SetLabelSize(0.03);
                  hMeansdZ[icharge][iarm][ized][icent]->GetYaxis()->SetTitleSize(0.05);

                  hMeansdZ[icharge][iarm][ized][icent]->GetXaxis()->SetTitle("p_{T} (GeV/c)");
                  hMeansdZ[icharge][iarm][ized][icent]->GetXaxis()->SetLabelSize(0.03);
                  hMeansdZ[icharge][iarm][ized][icent]->GetXaxis()->SetTitleSize(0.05);


                  if (ized == 0)
                    {
                      hMeansdZ[icharge][iarm][ized][icent]->Draw();
                    }
                  else
                    {
                      hMeansdZ[icharge][iarm][ized][icent]->Draw("same");
                    }

                  if (icharge == 0 && icent == 0 && ized < 5) legend1[iarm]->AddEntry(hMeansdZ[icharge][iarm][ized][icent], Form("%s", zed[ized]), "p");

                  if (icharge == 0 && icent == 0 && ized >= 5) legend2[iarm]->AddEntry(hMeansdZ[icharge][iarm][ized][icent], Form("%s", zed[ized]), "p");
      ...
      cmean[iarm]->SaveAs(Form("/direct/phenix+hhj/arbint/plots/Pc3EmcMatching/dz/meanSigma/mean_Arm%d.png", iarm));
      cmean[iarm]->Close();
    }
  ...
  for (int ized = 0; ized < NZED; ized++)
    {
      ...
      if (ized == 0)
        {
          hMeansdZ[0][0][ized][0]->Draw();
        }
      else
        {
          hMeansdZ[0][0][ized][0]->Draw("same");
        }
      legend1[0]->Draw("same");
      legend2[0]->Draw("same");
      cSingleMean->Update();
    }
  cSingleMean->SaveAs("/direct/phenix+hhj/arbint/plots/Pc3EmcMatching/dz/meanSigma/mean_Single.png");
  cSingleMean->Close();
  ...
  for (int iarm = 0; iarm < NARM; iarm++)
    {
          ...
          for (int icharge = 0; icharge < NCHARGE; icharge++)
            {
              ...
              for (int ized = 0; ized < NZED; ized++)
                {
                  hSigmasdZ[icharge][iarm][ized][icent]->SetStats(0);
                  hSigmasdZ[icharge][iarm][ized][icent]->SetMaximum(6.0);
                  hSigmasdZ[icharge][iarm][ized][icent]->SetMinimum(-1.0);

                  hSigmasdZ[icharge][iarm][ized][icent]->GetYaxis()->SetTitle("#sigma_{sdZ}");
                  hSigmasdZ[icharge][iarm][ized][icent]->GetYaxis()->SetLabelSize(0.03);
                  hSigmasdZ[icharge][iarm][ized][icent]->GetYaxis()->SetTitleSize(0.05);

                  hSigmasdZ[icharge][iarm][ized][icent]->GetXaxis()->SetTitle("p_{T} (GeV/c)");
                  hSigmasdZ[icharge][iarm][ized][icent]->GetXaxis()->SetLabelSize(0.03);
                  hSigmasdZ[icharge][iarm][ized][icent]->GetXaxis()->SetTitleSize(0.05);

                  if (ized == 0)
                    {
                      hSigmasdZ[icharge][iarm][ized][icent]->Draw();
                    }
                  else
                    {
                      hSigmasdZ[icharge][iarm][ized][icent]->Draw("same");
                    }

                  if (icharge == 0 && icent == 0 && ized < 5) legend11[iarm]->AddEntry(hSigmasdZ[icharge][iarm][ized][icent], Form("%s", zed[ized]), "p");

                  if (icharge == 0 && icent == 0 && ized >= 5) legend22[iarm]->AddEntry(hSigmasdZ[icharge][iarm][ized][icent], Form("%s", zed[ized]), "p");
      ...
      csigma[iarm]->SaveAs(Form("/direct/phenix+hhj/arbint/plots/Pc3EmcMatching/dz/meanSigma/sigma_Arm%d.png", iarm));
      csigma[iarm]->Close();
    }
  ...
  for (int ized = 0; ized < NZED; ized++)
    {
      ...
      if (ized == 0)
        {
          hSigmasdZ[0][0][ized][0]->Draw();
        }
      else
        {
          hSigmasdZ[0][0][ized][0]->Draw("same");
        }
  ...
  cSingleSigma->SaveAs("/direct/phenix+hhj/arbint/plots/Pc3EmcMatching/dz/meanSigma/sigma_Single.png");
  cSingleSigma->Close();
}
