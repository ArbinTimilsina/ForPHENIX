			 ...
			 )
{
    ...
    gSystem->Load("libEnergyScaleChecks.so");
    ...
    EnergyScaleChecks *EnergyScaleChecks = new EnergyScaleChecks();
    EnergyScaleChecks->SetCuAu(isCuAu);
    se->registerSubsystem(EnergyScaleChecks);
