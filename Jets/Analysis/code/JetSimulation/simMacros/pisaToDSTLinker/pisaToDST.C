//Arbin Timilsina, March 12, 2014
void pisaToDST(
	       Int_t nEvents = 0,
	       int runNumber = 372524,
	       ...
	       )
{
    ...
    */
    ...
    rc->set_CharFlag("PADDEADCHFILE", "pad_deadch.dat");
    rc->set_CharFlag("PADDEADROCFILE", "pad_deadroc.dat");
    cout << "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++" << endl << endl;

    // Added 2/15/2014: Don't know what the defult values are- so set everything to 0.0
    ...
    //Modified March 12, 2014: This should happen after BBCSimreco
    ...
    cout << "If you do not see this message, the job failed." << endl;
    cout << "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++" << endl << endl;
}
