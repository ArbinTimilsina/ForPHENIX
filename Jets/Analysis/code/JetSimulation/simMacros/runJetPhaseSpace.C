void runJetPhaseSpace(const int nevents = 0,
                      ...
                      const char *simDstFile = "SimDST.root")
{
    ...
    gSystem->Load("libJetPhaseSpace.so");
    ...
    JetPhaseSpace *JetPhaseSpace = new JetPhaseSpace();
    se->registerSubsystem(JetPhaseSpace);
