...
{
  TOAD *toad_loader4 = new TOAD("JetAnalyzer");
...
void LoadMean()
{
  TOAD *toad_loader5 = new TOAD("JetAnalyzer");
...
void LoadSigma()
{
  TOAD *toad_loader6 = new TOAD("JetAnalyzer");
...
{
  TOAD *toad_loader7 = new TOAD("JetAnalyzer");
...
{
  TOAD *toad_loader8 = new TOAD("JetAnalyzer");
