...
void RooUnfoldExample()
{
  ...
  cout << "==================================== TRAIN ====================================" << endl;
  TFile *fileCuAuMB = new TFile("/direct/phenix+hhj/arbint/RootFiles/JetAnalyzerPP_ERT.root", "READ");
  TH1F *hMeas = (TH1F*)fileCuAuMB->Get("hPtMB");

  TFile *fileSimCuAuCent1 = new TFile("/direct/phenix+hhj/arbint/JetSimulation/JetAnalyzerSim/PP/JetAnalyzerSim.root", "r");
  TH2F *hResponse = (TH2F*)fileSimCuAuCent1->Get("hPisaRecoResponseMatrix");
  TH1F *hTrue          = (TH1F*)fileSimCuAuCent1->Get("hPtTrueJet");
  TH1F *hM          = (TH1F*)fileSimCuAuCent1->Get("hPtPisaRecoMatchedJet");

  RooUnfoldResponse response(hM, hTrue, hResponse);
