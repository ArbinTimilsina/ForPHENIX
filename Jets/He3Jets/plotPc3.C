...
void plotPc3()
{
    ...
    TF1 *fPeakPC3dphi = new TF1("fPeakPC3dphi", "gaus(0)", -0.005, 0.005);
    fPeakPC3dphi->SetParameters(invPC3dphi / 50, meanPC3dphi, rmsPC3dphi);
    fPeakPC3dphi->SetLineColor(2);

    hPC3dphi->Fit("fPeakPC3dphi", "MRQ", "", -0.005, 0.005);
    ...
    TF1 *fPeakPC3dz = new TF1("fPeakPC3dz", "gaus(0)", -3.0, 3.0);
    fPeakPC3dz->SetParameters(invPC3dz / 50, meanPC3dz, rmsPC3dz);
    fPeakPC3dz->SetLineColor(2);

    hPC3dz->Fit("fPeakPC3dz", "MRQ", "", -3.0, 3.0);
    ...
    cPc3->Update();
    cPc3->SaveAs("/gpfs/mnt/gpfs02/phenix/spin/spin1/phnxsp01/arbint/He3Jet/plots/Pc3.png");
}
