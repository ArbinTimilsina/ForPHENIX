...
my $eventDir = "/gpfs/mnt/gpfs02/phenix/spin/spin1/phnxsp01/arbint/Run13Simulation/JetHadCorrection/510GeV/parton";
...
#Set PYTHIA
    ...
    print JETHADCORRECTION_CMD "ln -sf /direct/phenix+u/arbint/Jets/Run13Jets/condor/JetHadCorrection/510GeV/pythia.parton pythia.cfg\n";
