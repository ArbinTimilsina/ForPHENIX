void generatePythia(const float minPt = 5.0, const int nevents = 10, const char *outputname = "phpythia.root")
{
    ...
    Run13JetTriggerPythia *jetTriggerPythia = new Run13JetTriggerPythia(minPt, nevents);
