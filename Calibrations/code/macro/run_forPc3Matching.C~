void run_forEMCalMatching(char* outfile = "forEMCalMatching.root", int nevents = 1000)
{
  ...
  gSystem->Load("libforEMCalMatching.so");
  ...
  SubsysReco *forEMCalMatching = new forEMCalMatching(outfile);
  forEMCalMatching->Verbosity(1);
  se->registerSubsystem(forEMCalMatching);
